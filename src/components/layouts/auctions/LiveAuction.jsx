    ...
    <div className="fl-item col-xl-3 col-lg-6 col-md-6">
        <div className="sc-card-product">
            <div className="card-media">
                <Link to="/ItemDetails"><img src={props.item.img} alt="AxelarNFT" /></Link>
                ...
                <div className="button-place-bid">
                    <Link to="/wallet-connect" className="sc-button style-place-bid style bag fl-button pri-3"><span>Buy Now</span></Link>
                </div>
            </div>
            ...
            <div className="meta-info">
                <div className="author">
                    <div className="avatar">
                        <img src={props.item.imgAuthor} alt="AxelarNFT" />
                    </div>
                    <div className="info">
                        <span>Creator</span>
