...
import PlayAxelar from "../components/PlayAxelar";
...
const UseCase = () => {
  ...
  const [content,setContent] = useState(<PlayAxelar />)
  const [contentName,setContentName] = useState('PlayAxelar')
          ...
          <div className="usecase-section">
            ...
            <div className="d-flex" style={{paddingTop:'4rem'}}>
              <div className="mb-auto p-2">
                <div className="usecase-box d-flex justify-content-between align-items-center pd-20" style={{cursor:'pointer'}} 
                      onClick={() => {setContent(<PlayAxelar />)
                ...
                <div className="usecase-box d-flex justify-content-between align-items-center pd-20" style={{cursor:'pointer'}} 
                      onClick={() => {
                        setContent(<CollateralLending />)
                        setContentName('CollateralLending')
                        }}>
                  <div>
